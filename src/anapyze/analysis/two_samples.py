...
def run_anova_with_covariate_atlas(group1, group2, group1_covar, group2_covar, atlas_path, output_path, operation="mean"):
    ...
    for roi in rois:
        ...
        f_test = model.f_test("group_1")  
        
        f_stats[mask] = f_test.fvalue.item()
